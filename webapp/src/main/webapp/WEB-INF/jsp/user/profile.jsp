...
<main class="container-50 pusher container-account">
  ...
  <sl-card class="card-basic">
    ...
    <div class="button-row">
      ...
      <form method="post" action="<c:url value="/change-degree" />">
        <sl-tooltip trigger="click">
          <div class="clickable" slot="content">
            <sl-card>
              <div class="column-center">
                <span><spring:message code="profile.update.degree.warning"/></span>
                <div style="padding-top: 1rem;" class="row">
                  <sl-button style="padding-right: 1rem " type="submit" class="delete-button" label="delete">
          ...
          <sl-button variant="primary" outline><spring:message code="profile.update.degree"/></sl-button>
        </sl-tooltip>
      </form>
    </div>
  </sl-card>
