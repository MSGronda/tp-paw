...
//            for (Degree deg : sub.getDegrees()) {
//                List<Subject> degSubs = map.getOrDefault(deg.getId(), new ArrayList<>());
//                degSubs.add(sub);
//                map.putIfAbsent(deg.getId(), degSubs);
//            }
//        }
//        return map;
//    }
...
//            idProf.ifPresent(id -> sub.getProfessors().add(id));
//            idDeg.ifPresent(id -> sub.getDegrees().add(id));
//
//            subs.putIfAbsent(idSub, sub);
//        }
//
