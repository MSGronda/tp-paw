...
//
//            SubjectClass subjectClass = sub.getClassesById().getOrDefault(idSub + idClass, new SubjectClass(idSub, idClass));
//            subjectClass.getClassTimes().add(new SubjectClassTime(day, start.toLocalTime(), end.toLocalTime(), classNumber, building, mode));
//
//            sub.getClassesById().put(idSub + idClass, subjectClass);
...
//
//            subClass.getClassTimes().add(new SubjectClassTime(day, start.toLocalTime(), end.toLocalTime(), classNumber, building, mode));
