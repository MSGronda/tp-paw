...
//        data.put("easy", review.getDifficulty());
//        data.put("timeDemanding", review.getTimeDemanding());
//        data.put("revText", review.getText());
//        data.put("idSub", review.getSubject());
//        data.put("idUser", review.getUser());
...
//            .build();
//
//        LOGGER.info("Review created with id {} by user {} with anonymous visibility {}", review.getId(), review.getUser(), review.getAnonymous());
//        return newRev;
//    }
//
//    @Override
...
//        LOGGER.info("Review updated with id {} by user {}", review.getId(), review.getUser());
//
//        jdbcTemplate.update("UPDATE " + Tables.REVIEWS + " SET revtext = ?, " +
//                "easy = ?, timedemanding = ?, useranonymous = ? WHERE id = ?",
//            review.getText(), review.getDifficulty(), review.getTimeDemanding(), review.getAnonymous(), review.getId());
//    }
//
//    // - - - - - REVIEW STATISTICS - - - - -
//
...
//            .id(rs.getLong("id"))
//            .user(rs.getLong("idUser"))
//            .subject(rs.getString("idSub"))
//            .difficulty(rs.getInt("easy"))
...
//
//    @Override
//    public Integer deleteReviewVotes(final Long idReview) {
