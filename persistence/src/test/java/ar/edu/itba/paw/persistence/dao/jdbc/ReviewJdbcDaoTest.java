...
//        Assert.assertEquals(USERID, review.get().getUser());
//        Assert.assertEquals(SUBJECTID, review.get().getSubject());
...
//        Assert.assertEquals(DIFFICULTY, list.get(0).getDifficulty());
//        Assert.assertEquals(HARD, list.get(1).getDifficulty());
//        Assert.assertEquals(USERID, list.get(0).getUser());
//        Assert.assertEquals(USERID2, list.get(1).getUser());
//
...
//        Assert.assertEquals(USERID, review.getUser());
//        Assert.assertEquals(SUBJECTID, review.getSubject());
...
//
//
//        reviewDao.deleteReviewVotes(ID);
//
//        String query = "iduser = " + USERID + " AND idreview = " + ID + " AND vote = " + VOTE;
