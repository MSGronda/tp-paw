...
//        Assert.assertArrayEquals(image, maybeImage.get().getImage());
//    }
//
//    @Test
...
//        Assert.assertArrayEquals(image, list.get(0).getImage());
//        Assert.assertArrayEquals(image2, list.get(1).getImage());
//
//    }
//
//    @Test
...
//
//        final byte[] imageToUpload = Files.readAllBytes(IMAGE2.toPath());
//        imageDao.update(key1, imageToUpload);
//
//        String query = "id = " + key1;
//        Assert.assertEquals(1, JdbcTestUtils.countRowsInTableWhere(jdbcTemplate, "images", query));
//
