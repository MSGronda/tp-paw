...
//        Assert.assertEquals(CLASSA, list.get(0).getClassId());
//        Assert.assertEquals(CLASSB, list.get(1).getClassId());
//
//    }
//
//    @Test
...
//        Assert.assertEquals(CLASSA, list.get(0).getClassesById().get(SUBJECTID+CLASSA).getClassId());
//        Assert.assertEquals(BUILDING, list.get(0).getClassesById().get(SUBJECTID+CLASSA).getClassTimes().stream().findFirst().get().getBuilding());
//        Assert.assertEquals(CLASS, list.get(0).getClassesById().get(SUBJECTID+CLASSA).getClassTimes().stream().findFirst().get().getClassLoc());
//        Assert.assertEquals(DAY, list.get(0).getClassesById().get(SUBJECTID+CLASSA).getClassTimes().stream().findFirst().get().getDay());
//
//    }
//}
